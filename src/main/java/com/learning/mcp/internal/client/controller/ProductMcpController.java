...
import com.learning.mcp.internal.client.service.ProductMcpChatService;
...
@Tag(name = "Internal Product MCP API", description = "Endpoints for AI-driven Product Catalog management via Internal MCP Server Tools")
public class ProductMcpController {

    private final ProductMcpChatService productMcpChatService;

    @GetMapping("/chat")
    @Operation(summary = "Chat with AI using Internal Product Catalog MCP Tools", description = "Allows natural language interaction to add, search, update, or delete products using internal MCP Server Tools.")
